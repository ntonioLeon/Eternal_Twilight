...
public class ArcherBattleState : EnemyState
{
    ...
    private int moveDir;
    public ArcherBattleState(Enemigo enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Archer enemy) : base(enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = enemy;
    }
